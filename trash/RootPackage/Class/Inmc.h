...
// Tue Nov 25 23:42:26 2014 by ROOT version 5.34/07
// from TChain save/
//////////////////////////////////////////////////////////
...
Int_t Inmc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Inmc::LoadTree(Long64_t entry)
{
