...
void MakeLegend(TH1 * datahist,   // Histogram with data
		...
		double xlow = 0.5,      // Left edge of legend 
		                  //(fraction of canavas width)
		double ylow = 0.82,       // Bottom edge of legend
		                  //(fraction of canavas height)
		double xhi = 0.9,       // Right edge of legend 
		                  //(fraction of canavas width)
		double yhi = 0.99);       // Top edge of legend
		                  //(fraction of canavas height)
