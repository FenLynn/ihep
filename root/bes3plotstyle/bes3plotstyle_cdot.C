...
void FormatMC1(TH1 * mc1hist){
  mc1hist->SetMarkerStyle(21);
  mc1hist->SetMarkerSize(1);
  mc1hist->SetMarkerColor(2);
...
void FormatMC2(TH1 * mc2hist){
  mc2hist->SetMarkerStyle(22);
  mc2hist->SetMarkerColor(4);
  mc2hist->SetMarkerSize(1.5);
}
...
void FormatMC3(TGraph * mc3hist){
  mc3hist->SetMarkerStyle(29);
  mc3hist->SetMarkerColor(3);
  mc3hist->SetMarkerSize(1.5);
}
